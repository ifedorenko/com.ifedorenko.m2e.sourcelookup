...
{
    public static void injectFrameworkExtension( File configurationDirectory )
    ...
    public static ILaunch getLaunch( ILaunchConfiguration configuration, String mode )
        throws CoreException
    {
    ...
    public static List<String> appendJavaagentString( List<String> jvmargs )
        throws CoreException
    {
    ...
    public static String[] appendJavaagentString( String[] jvmargs )
        throws CoreException
    {
