...
class BackgroundProcessingJob extends Job {
  ...
  protected IStatus run(IProgressMonitor monitor) {
    ...
    return new MultiStatus(SourceLookupActivator.PLUGIN_ID, IStatus.ERROR, errors.toArray(new IStatus[errors.size()]),
        "Background task failed", null);
  }
